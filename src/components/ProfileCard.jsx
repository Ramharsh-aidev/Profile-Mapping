...
// (Using the last provided version of ProfileCard, which is suitable)
...
const ProfileCard = ({ profile, onViewOnMap }) => {
  ...
  return (
    // bg-white will contrast with the new gradient background of the list pane
    <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 flex p-3 text-slate-800"> {/* Added text-slate-800 for default text color */}
      <img
        src={avatar}
        alt={username}
